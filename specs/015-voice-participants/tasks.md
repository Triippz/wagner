...
> - ✅ **Projection allowlist policy** — `edge/host/src/participants/voice_projection.rs` (`speakable_text`, FR-009). The pure SC-004 allowlist; the Agent impl (subscribe→Tts→playback) is deferred. Covers the policy half of T035/T037.
